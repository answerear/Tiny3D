...
@del /Q ..\..\source
@set input_file=CommonScriptObject.proto MaterialScriptObject.proto ModelScriptObject.proto LevelScriptObject.proto FileScriptObject.proto MetaScriptObject.proto ShaderScriptObject.proto
