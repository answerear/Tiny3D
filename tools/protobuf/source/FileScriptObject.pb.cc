...
extern PROTOBUF_INTERNAL_EXPORT_ShaderScriptObject_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_Shader_ShaderScriptObject_2eproto;
namespace Tiny3D {
namespace Script {
...
class FileShaderDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<FileShader> _instance;
} _FileShader_default_instance_;
...
static void InitDefaultsscc_info_FileShader_FileScriptObject_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::Tiny3D::Script::FileFormat::_FileShader_default_instance_;
    new (ptr) ::Tiny3D::Script::FileFormat::FileShader();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::Tiny3D::Script::FileFormat::FileShader::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_FileShader_FileScriptObject_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_FileShader_FileScriptObject_2eproto}, {
      &scc_info_FileHeader_FileScriptObject_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_FileScriptObject_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Tiny3D::Script::FileFormat::FileShader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::Tiny3D::Script::FileFormat::FileShader, header_),
  PROTOBUF_FIELD_OFFSET(::Tiny3D::Script::FileFormat::FileShader, shader_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 15, -1, sizeof(::Tiny3D::Script::FileFormat::FileShader)},
  { 22, -1, sizeof(::Tiny3D::Script::FileFormat::FileMeta)},
  { 29, 36, sizeof(::Tiny3D::Script::FileFormat::FileLevelData_NodesEntry_DoNotUse)},
  { 38, 45, sizeof(::Tiny3D::Script::FileFormat::FileLevelData_MeshesEntry_DoNotUse)},
  { 47, 54, sizeof(::Tiny3D::Script::FileFormat::FileLevelData_AnimationsEntry_DoNotUse)},
  { 56, -1, sizeof(::Tiny3D::Script::FileFormat::FileLevelData)},
  { 65, -1, sizeof(::Tiny3D::Script::FileFormat::FileLevel)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::Tiny3D::Script::FileFormat::_FileShader_default_instance_),
...
const char descriptor_table_protodef_FileScriptObject_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "FileFormat\032\030ShaderScriptObject.proto\032\032Ma"
  "terialScriptObject.proto\032\027ModelScriptObj"
  "ect.proto\032\027LevelScriptObject.proto\032\026Meta"
  "ScriptObject.proto\"\244\001\n\nFileHeader\022\r\n\005mag"
  "ic\030\001 \001(\t\022;\n\004type\030\002 \001(\0162-.Tiny3D.Script.F"
  "ileFormat.FileHeader.FileType\022\017\n\007version"
  "\030\003 \001(\007\"9\n\010FileType\022\014\n\010Material\020\000\022\t\n\005Leve"
  "l\020\001\022\010\n\004Meta\020\002\022\n\n\006Shader\020\003\"~\n\014FileMateria"
  "l\0224\n\006header\030\001 \001(\0132$.Tiny3D.Script.FileFo"
  "rmat.FileHeader\0228\n\010material\030\002 \001(\0132&.Tiny"
  "3D.Script.MaterialSystem.Material\"v\n\nFil"
  "eShader\0224\n\006header\030\001 \001(\0132$.Tiny3D.Script."
  "FileFormat.FileHeader\0222\n\006shader\030\002 \001(\0132\"."
  "Tiny3D.Script.ShaderSystem.Shader\"r\n\010Fil"
  "eMeta\0224\n\006header\030\001 \001(\0132$.Tiny3D.Script.Fi"
  "leFormat.FileHeader\0220\n\004meta\030\002 \001(\0132\".Tiny"
  "3D.Script.MetaSystem.MetaData\"\362\003\n\rFileLe"
  "velData\022\014\n\004root\030\001 \001(\t\022A\n\005nodes\030\002 \003(\01322.T"
  "iny3D.Script.FileFormat.FileLevelData.No"
  "desEntry\022C\n\006meshes\030\003 \003(\01323.Tiny3D.Script"
  ".FileFormat.FileLevelData.MeshesEntry\022K\n"
  "\nanimations\030\004 \003(\01327.Tiny3D.Script.FileFo"
  "rmat.FileLevelData.AnimationsEntry\032M\n\nNo"
  "desEntry\022\013\n\003key\030\001 \001(\t\022.\n\005value\030\002 \001(\0132\037.T"
  "iny3D.Script.LevelSystem.Node:\0028\001\032R\n\013Mes"
  "hesEntry\022\013\n\003key\030\001 \001(\t\0222\n\005value\030\002 \001(\0132#.T"
  "iny3D.Script.ModelSystem.MeshData:\0028\001\032[\n"
  "\017AnimationsEntry\022\013\n\003key\030\001 \001(\t\0227\n\005value\030\002"
  " \001(\0132(.Tiny3D.Script.ModelSystem.Animati"
  "onClip:\0028\001\"x\n\tFileLevel\0224\n\006header\030\001 \001(\0132"
  "$.Tiny3D.Script.FileFormat.FileHeader\0225\n"
  "\004data\030\002 \001(\0132\'.Tiny3D.Script.FileFormat.F"
  "ileLevelDatab\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_FileScriptObject_2eproto_deps[5] = {
  ...
  &::descriptor_table_ShaderScriptObject_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_FileScriptObject_2eproto_sccs[9] = {
  ...
  &scc_info_FileShader_FileScriptObject_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_FileScriptObject_2eproto = {
  &descriptor_table_FileScriptObject_2eproto_initialized, descriptor_table_protodef_FileScriptObject_2eproto, "FileScriptObject.proto", 1340,
  &descriptor_table_FileScriptObject_2eproto_once, descriptor_table_FileScriptObject_2eproto_sccs, descriptor_table_FileScriptObject_2eproto_deps, 9, 5,
...
constexpr FileHeader_FileType FileHeader::Shader;
...
void FileShader::InitAsDefaultInstance() {
  ::Tiny3D::Script::FileFormat::_FileShader_default_instance_._instance.get_mutable()->header_ = const_cast< ::Tiny3D::Script::FileFormat::FileHeader*>(
      ::Tiny3D::Script::FileFormat::FileHeader::internal_default_instance());
  ::Tiny3D::Script::FileFormat::_FileShader_default_instance_._instance.get_mutable()->shader_ = const_cast< ::Tiny3D::Script::ShaderSystem::Shader*>(
      ::Tiny3D::Script::ShaderSystem::Shader::internal_default_instance());
}
class FileShader::_Internal {
 public:
  static const ::Tiny3D::Script::FileFormat::FileHeader& header(const FileShader* msg);
  static const ::Tiny3D::Script::ShaderSystem::Shader& shader(const FileShader* msg);
};

const ::Tiny3D::Script::FileFormat::FileHeader&
FileShader::_Internal::header(const FileShader* msg) {
  return *msg->header_;
}
const ::Tiny3D::Script::ShaderSystem::Shader&
FileShader::_Internal::shader(const FileShader* msg) {
  return *msg->shader_;
}
void FileShader::clear_shader() {
  if (GetArenaNoVirtual() == nullptr && shader_ != nullptr) {
    delete shader_;
  }
  shader_ = nullptr;
}
FileShader::FileShader()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Tiny3D.Script.FileFormat.FileShader)
}
FileShader::FileShader(const FileShader& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  if (from._internal_has_header()) {
  ...
  if (from._internal_has_shader()) {
    shader_ = new ::Tiny3D::Script::ShaderSystem::Shader(*from.shader_);
  } else {
    shader_ = nullptr;
  }
  // @@protoc_insertion_point(copy_constructor:Tiny3D.Script.FileFormat.FileShader)
}

void FileShader::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_FileShader_FileScriptObject_2eproto.base);
  ::memset(&header_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&shader_) -
      reinterpret_cast<char*>(&header_)) + sizeof(shader_));
}

FileShader::~FileShader() {
  // @@protoc_insertion_point(destructor:Tiny3D.Script.FileFormat.FileShader)
  SharedDtor();
}

void FileShader::SharedDtor() {
  if (this != internal_default_instance()) delete header_;
  if (this != internal_default_instance()) delete shader_;
}

void FileShader::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const FileShader& FileShader::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_FileShader_FileScriptObject_2eproto.base);
  return *internal_default_instance();
}


void FileShader::Clear() {
// @@protoc_insertion_point(message_clear_start:Tiny3D.Script.FileFormat.FileShader)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* FileShader::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        ...
        continue;
      // .Tiny3D.Script.ShaderSystem.Shader shader = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
...
::PROTOBUF_NAMESPACE_ID::uint8* FileShader::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Tiny3D.Script.FileFormat.FileShader)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Tiny3D.Script.FileFormat.FileShader)
  return target;
}

size_t FileShader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Tiny3D.Script.FileFormat.FileShader)
  size_t total_size = 0;
...
void FileShader::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:Tiny3D.Script.FileFormat.FileShader)
  GOOGLE_DCHECK_NE(&from, this);
  const FileShader* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<FileShader>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:Tiny3D.Script.FileFormat.FileShader)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:Tiny3D.Script.FileFormat.FileShader)
    MergeFrom(*source);
  }
}

void FileShader::MergeFrom(const FileShader& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:Tiny3D.Script.FileFormat.FileShader)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.has_shader()) {
    _internal_mutable_shader()->::Tiny3D::Script::ShaderSystem::Shader::MergeFrom(from._internal_shader());
  }
}

void FileShader::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:Tiny3D.Script.FileFormat.FileShader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void FileShader::CopyFrom(const FileShader& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Tiny3D.Script.FileFormat.FileShader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool FileShader::IsInitialized() const {
  return true;
}

void FileShader::InternalSwap(FileShader* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(header_, other->header_);
...
::PROTOBUF_NAMESPACE_ID::Metadata FileShader::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::Tiny3D::Script::FileFormat::FileShader* Arena::CreateMaybeMessage< ::Tiny3D::Script::FileFormat::FileShader >(Arena* arena) {
  return Arena::CreateInternal< ::Tiny3D::Script::FileFormat::FileShader >(arena);
}
