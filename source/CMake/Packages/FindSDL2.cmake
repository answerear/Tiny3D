...
FIND_LIBRARY(SDL2_LIBRARY_TEMP
  NAMES SDL2-2.0 SDL2
  HINTS ${SDL2DIR}
  PATH_SUFFIXES lib64 lib ${SDL2LIB_SUFFIXES} ${SDL2LIB_SUFFIXES}/lib
#  PATHS
#  /sw
#  /opt/local
#  /opt/csw
...
FIND_FILE(SDL2_BINARY
  ...
  HINTS ${SDL2DIR}
  PATH_SUFFIXES lib64 lib ${SDL2LIB_SUFFIXES} ${SDL2LIB_SUFFIXES}/bin
)
...
IF(SDL2_LIBRARY_TEMP)
  ...
  # For iOS and macOS, SDL2 is statically linked, add SDL_STATIC definition
  IF(APPLE)
