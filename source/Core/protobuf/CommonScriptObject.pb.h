...
template<> ::Tiny3D::Script::Vector4* Arena::CreateMaybeMessage<::Tiny3D::Script::Vector4>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Tiny3D {
namespace Script {
...
class Vector4 :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Tiny3D.Script.Vector4) */ {
 public:
  Vector4();
  virtual ~Vector4();
  ...
  // @@protoc_insertion_point(class_scope:Tiny3D.Script.Vector4)
 private:
  class _Internal;
...
inline float Vector4::x() const {
  // @@protoc_insertion_point(field_get:Tiny3D.Script.Vector4.x)
  return _internal_x();
}
...
inline void Vector4::set_x(float value) {
  _internal_set_x(value);
  // @@protoc_insertion_point(field_set:Tiny3D.Script.Vector4.x)
}
...
inline float Vector4::y() const {
  // @@protoc_insertion_point(field_get:Tiny3D.Script.Vector4.y)
  return _internal_y();
}
...
inline void Vector4::set_y(float value) {
  _internal_set_y(value);
  // @@protoc_insertion_point(field_set:Tiny3D.Script.Vector4.y)
}
...
inline float Vector4::z() const {
  // @@protoc_insertion_point(field_get:Tiny3D.Script.Vector4.z)
  return _internal_z();
}
...
inline void Vector4::set_z(float value) {
  _internal_set_z(value);
  // @@protoc_insertion_point(field_set:Tiny3D.Script.Vector4.z)
}
...
inline float Vector4::w() const {
  // @@protoc_insertion_point(field_get:Tiny3D.Script.Vector4.w)
  return _internal_w();
}
...
inline void Vector4::set_w(float value) {
  ...
  // @@protoc_insertion_point(field_set:Tiny3D.Script.Vector4.w)
}
