...
namespace Tiny3D
{
     ...
     */
    class T3D_ENGINE_API RHIPixelBuffer : public RHIBuffer
    {
    public:
        /**
         * @brief   析构函数
         */
        ~RHIPixelBuffer() override;
         ...
         * @sa  enum LockOptions
         */
        virtual void *lock(const Rect &rect, LockOptions options, size_t &lockedPitch);
         ...
         */
        void *lock(LockOptions options) override;
         ...
         *    会自动缩放匹配源和目标区域.
         */
        virtual TResult copyTo(RHIPixelBufferPtr dst, Rect *dstRect = nullptr, Rect *srcRect = nullptr);
         ...
         *    会自动缩放匹配源和目标区域.
         */
        virtual TResult readImage(const Image &image, Rect *srcRect = nullptr, Rect *dstRect = nullptr) = 0;
         ...
         *    会自动缩放匹配源和目标区域.
         */
        virtual TResult writeImage(Image &image, Rect *dstRect = nullptr, Rect *srcRect = nullptr) = 0;
    ...
    protected:
         ...
         */
        RHIPixelBuffer(size_t width, size_t height, PixelFormat format, Usage usage, uint32_t mode, size_t mipmaps);
    ...
    private:
         ...
         * @sa  enum LockOptions
         */
        virtual void *lockImpl(const Rect &rect, LockOptions options, size_t &lockedPitch) = 0;
         ...
         */
        size_t readData(size_t offset, size_t size, void *dst) override;
         ...
         */
        size_t writeData(size_t offset, size_t size, const void *src, bool discardWholeBuffer = false) override;
