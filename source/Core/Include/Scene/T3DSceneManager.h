...
namespace Tiny3D
{
    ...
    public:
         ...
         */
        SceneNodePtr getRoot() const override;
         ...
         */
        SceneNodePtr createSceneNode(SceneNodePtr parent, ID uID = Node::E_NID_AUTOMATIC) override;
         ...
         */
        TResult addSceneNode(SceneNode *node) override;
         ...
         * @return  调用成功返回 T3D_OK.
         */
        TResult removeSceneNode(SceneNode *node) override;

        void setComponentOrder(const Class *cls, uint32_t order) override;

        uint32_t getComponentOrder(const Class *cls) const override;

        const OrderMap &getComponentOrders() const override;
