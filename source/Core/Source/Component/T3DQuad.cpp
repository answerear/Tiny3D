...
RTTR_REGISTRATION
{
    ...
    registration::class_<Tiny3D::Quad>("Tiny3D::Quad")
        .enumeration<Tiny3D::Quad::VertexIndex>("Tiny3D::Quad::VertexIndex")
        (
            value("VI_TOP_LEFT", Tiny3D::Quad::VertexIndex::VI_TOP_LEFT),
            value("VI_TOP_RIGHT", Tiny3D::Quad::VertexIndex::VI_TOP_RIGHT),
            value("VI_BOTTOM_LEFT", Tiny3D::Quad::VertexIndex::VI_BOTTOM_LEFT),
            value("VI_BOTTOM_RIGHT", Tiny3D::Quad::VertexIndex::VI_BOTTOM_RIGHT),
            value("VI_MAX_VERTICES", Tiny3D::Quad::VertexIndex::VI_MAX_VERTICES)
        )
        .constructor(&Tiny3D::Quad::create)
        .method("setVertexPos", &Tiny3D::Quad::setVertexPos)
        .method("getVertexPos", &Tiny3D::Quad::getVertexPos)
        .method("setVertexUV", &Tiny3D::Quad::setVertexUV)
        .method("getVertexUV", &Tiny3D::Quad::getVertexUV)
        .method("clone", &Tiny3D::Quad::clone)
        .method("getMaterial", &Tiny3D::Quad::getMaterial)
        .method("getVertexArrayObject", &Tiny3D::Quad::getVertexArrayObject)
        .property("QuadData", &Tiny3D::Quad::mQuad, registration::protected_access)
        (
            metadata(TXT_DESCRIPTION, "The data of this quad.")
        );

    registration::class_<Tiny3D::Quad::QuadData>("Tiny3D::Quad::QuadData")
        .constructor()
        .property("Vertices", &Tiny3D::Quad::QuadData::vertices)
        (
            metadata(TXT_DESCRIPTION, "The vertices of this quad.")
        );

    registration::class_<Tiny3D::Quad::Vertex>("Tiny3D::Quad::Vertex")
        .constructor()
        .property("Position", &Tiny3D::Quad::Vertex::position)
        (
            metadata(TXT_DESCRIPTION, "The position of this vertex.")
            )
        .property("UV", &Tiny3D::Quad::Vertex::uv)
        (
            metadata(TXT_DESCRIPTION, "The uv coordination in texture of this vertex.")
        );
}
