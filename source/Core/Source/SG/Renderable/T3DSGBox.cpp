...
//         mVertices[0].diffuse = Vector4(1.0, 0.0, 0.0, 1.0);
        mVertices[0].diffuse = Color4::RED.A8R8G8B8();
        mVertices[1].position = Vector3(-50, -50, 0);
        mVertices[1].diffuse = Color4::RED.A8R8G8B8();
        mVertices[2].position = Vector3(-50, 50, 0);
        mVertices[2].diffuse = Color4::RED.A8R8G8B8();
        mVertices[3].position = Vector3(-50, 50, 0);
        mVertices[3].diffuse = Color4::RED.A8R8G8B8();
        mVertices[4].position = Vector3(50, 50, 0);
        mVertices[4].diffuse = Color4::RED.A8R8G8B8();
        mVertices[5].position = Vector3(50, 50, 100);
        mVertices[5].diffuse = Color4::RED.A8R8G8B8();
        mVertices[6].position = Vector3(-50, -50, 100);
        mVertices[6].diffuse = Color4::RED.A8R8G8B8();
        mVertices[7].position = Vector3(-50, 50, 100);
        mVertices[7].diffuse = Color4::RED.A8R8G8B8();
        mVertices[8].position = Vector3(-50, -50, 100);
        mVertices[8].diffuse = Color4::RED.A8R8G8B8();
        mVertices[9].position = Vector3(50, -50, 0);
        mVertices[9].diffuse = Color4::RED.A8R8G8B8();
        mVertices[10].position = Vector3(-50, 50, 0);
        mVertices[10].diffuse = Color4::RED.A8R8G8B8();
        mVertices[11].position = Vector3(50, -50, 0);
        mVertices[11].diffuse = Color4::RED.A8R8G8B8();
        mVertices[12].position = Vector3(-50, -50, 0);
        mVertices[12].diffuse = Color4::RED.A8R8G8B8();
        mVertices[13].position = Vector3(50, 50, 100);
        mVertices[13].diffuse = Color4::RED.A8R8G8B8();
        mVertices[14].position = Vector3(-50, -50, 100);
        mVertices[14].diffuse = Color4::RED.A8R8G8B8();
        mVertices[15].position = Vector3(-50, 50, 100);
        mVertices[15].diffuse = Color4::RED.A8R8G8B8();
        mVertices[16].position = Vector3(50, -50, 100);
        mVertices[16].diffuse = Color4::RED.A8R8G8B8();
        mVertices[17].position = Vector3(50, -50, 0);
        mVertices[17].diffuse = Color4::RED.A8R8G8B8();
        mVertices[18].position = Vector3(50, -50, 100);
        mVertices[18].diffuse = Color4::RED.A8R8G8B8();
        mVertices[19].position = Vector3(50, 50, 0);
        mVertices[19].diffuse = Color4::RED.A8R8G8B8();
        mVertices[20].position = Vector3(50, 50, 0);
        mVertices[20].diffuse = Color4::RED.A8R8G8B8();
        mVertices[21].position = Vector3(50, 50, 100);
        mVertices[21].diffuse = Color4::RED.A8R8G8B8();
        mVertices[22].position = Vector3(-50, 50, 100);
        mVertices[22].diffuse = Color4::RED.A8R8G8B8();
    }
