...
namespace Tiny3D
{
    ...
    /// 无效的接收者
    #define T3D_ERR_FWK_INVALID_RECVER          (T3D_ERR_FRAMEWORK + 1)
    /// 无效的发送者
    #define T3D_ERR_FWK_INVALID_SENDER          (T3D_ERR_FRAMEWORK + 2)
    /// 无效事件ID
    #define T3D_ERR_FWK_INVALID_EVID            (T3D_ERR_FRAMEWORK + 3)
