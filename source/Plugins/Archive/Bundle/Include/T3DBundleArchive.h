...
#ifndef __T3D_BUNDLE_ARCHIVE_H__
#define __T3D_BUNDLE_ARCHIVE_H__
...
namespace Tiny3D
{
     ...
     */
    class BundleArchive : public Archive
    {
    public:
         ...
         * @brief 创建对象
         */
        static BundleArchivePtr create(const String &name);
    ...
    protected:
         ...
         * @brief 构造函数
         */
        BundleArchive(const String &name);
...
#endif  /*__T3D_BUNDLE_ARCHIVE_H__*/
