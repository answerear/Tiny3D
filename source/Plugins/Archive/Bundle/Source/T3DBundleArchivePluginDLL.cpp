...
Tiny3D::BundleArchivePlugin *gPlugin = nullptr;

extern "C"
{
    T3D_BUNDLEARCHIVE_API TResult dllStartPlugin()
    {
        gPlugin = new Tiny3D::BundleArchivePlugin();
        return Tiny3D::Agent::getInstance().installPlugin(gPlugin);
    }

    T3D_BUNDLEARCHIVE_API TResult dllStopPlugin()
    {
