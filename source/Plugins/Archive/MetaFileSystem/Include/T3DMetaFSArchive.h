...
#ifndef __T3D_META_FS_ARCHIEVE_H__
#define __T3D_META_FS_ARCHIEVE_H__
...
namespace Tiny3D
{
     ...
     */
    class MetaFileSystemArchive : public Archive
    {
    public:
         ...
         * @brief 创建对象
         */
        static MetaFileSystemArchivePtr create(const String &name);

        /**
         * @brief 析构函数
         */
        virtual ~MetaFileSystemArchive();
    ...
    protected:
         ...
         * @brief 构造函数
         */
        MetaFileSystemArchive(const String &name);
...
#endif  /*__T3D_META_FS_ARCHIEVE_H__*/
