...
namespace Tiny3D
{
                                    ...
                                    Vector3& kD, Vector3& kU) const
    {
        ...
        Real fInvLength = Math::InvSqrt(_m3x3[0][0]*_m3x3[0][0] + _m3x3[1][0]*_m3x3[1][0] + _m3x3[2][0]*_m3x3[2][0]);

        kQ[0][0] = _m3x3[0][0]*fInvLength;
        kQ[1][0] = _m3x3[1][0]*fInvLength;
        kQ[2][0] = _m3x3[2][0]*fInvLength;

        Real fDot = kQ[0][0]*_m3x3[0][1] + kQ[1][0]*_m3x3[1][1] +
                    kQ[2][0]*_m3x3[2][1];
        kQ[0][1] = _m3x3[0][1]-fDot*kQ[0][0];
        kQ[1][1] = _m3x3[1][1]-fDot*kQ[1][0];
        kQ[2][1] = _m3x3[2][1]-fDot*kQ[2][0];
        ...
        fDot = kQ[0][0]*_m3x3[0][2] + kQ[1][0]*_m3x3[1][2] +
               kQ[2][0]*_m3x3[2][2];
        kQ[0][2] = _m3x3[0][2]-fDot*kQ[0][0];
        kQ[1][2] = _m3x3[1][2]-fDot*kQ[1][0];
        kQ[2][2] = _m3x3[2][2]-fDot*kQ[2][0];
        fDot = kQ[0][1]*_m3x3[0][2] + kQ[1][1]*_m3x3[1][2] +
               kQ[2][1]*_m3x3[2][2];
        kQ[0][2] -= fDot*kQ[0][1];
        kQ[1][2] -= fDot*kQ[1][1];
        kQ[2][2] -= fDot*kQ[2][1];
        ...
        Matrix3 kR;
        kR[0][0] = kQ[0][0]*_m3x3[0][0] + kQ[1][0]*_m3x3[1][0] +
                   kQ[2][0]*_m3x3[2][0];
        kR[0][1] = kQ[0][0]*_m3x3[0][1] + kQ[1][0]*_m3x3[1][1] +
                   kQ[2][0]*_m3x3[2][1];
        kR[1][1] = kQ[0][1]*_m3x3[0][1] + kQ[1][1]*_m3x3[1][1] +
                   kQ[2][1]*_m3x3[2][1];
        kR[0][2] = kQ[0][0]*_m3x3[0][2] + kQ[1][0]*_m3x3[1][2] +
                   kQ[2][0]*_m3x3[2][2];
        kR[1][2] = kQ[0][1]*_m3x3[0][2] + kQ[1][1]*_m3x3[1][2] +
                   kQ[2][1]*_m3x3[2][2];
        kR[2][2] = kQ[0][2]*_m3x3[0][2] + kQ[1][2]*_m3x3[1][2] +
                   kQ[2][2]*_m3x3[2][2];
