...
extern FileShaderDefaultTypeInternal _FileShader_default_instance_;
}  // namespace FileFormat
}  // namespace Script
}  // namespace Tiny3D
PROTOBUF_NAMESPACE_OPEN
...
template<> ::Tiny3D::Script::FileFormat::FileShader* Arena::CreateMaybeMessage<::Tiny3D::Script::FileFormat::FileShader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Tiny3D {
namespace Script {
namespace FileFormat {
...
constexpr FileHeader_FileType FileHeader_FileType_FileType_MAX = FileHeader_FileType_Shader;
...
class FileHeader :
 ...
 public:
  ...
  static constexpr FileType Shader =
    FileHeader_FileType_Shader;
...
class FileShader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Tiny3D.Script.FileFormat.FileShader) */ {
 public:
  FileShader();
  virtual ~FileShader();

  FileShader(const FileShader& from);
  FileShader(FileShader&& from) noexcept
    : FileShader() {
    *this = ::std::move(from);
  }

  inline FileShader& operator=(const FileShader& from) {
    CopyFrom(from);
    return *this;
  }
  inline FileShader& operator=(FileShader&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const FileShader& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const FileShader* internal_default_instance() {
    return reinterpret_cast<const FileShader*>(
               &_FileShader_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(FileShader& a, FileShader& b) {
    a.Swap(&b);
  }
  inline void Swap(FileShader* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline FileShader* New() const final {
    return CreateMaybeMessage<FileShader>(nullptr);
  }

  FileShader* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<FileShader>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const FileShader& from);
  void MergeFrom(const FileShader& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(FileShader* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Tiny3D.Script.FileFormat.FileShader";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  public:
  void clear_shader();
  const ::Tiny3D::Script::ShaderSystem::Shader& shader() const;
  ::Tiny3D::Script::ShaderSystem::Shader* release_shader();
  ::Tiny3D::Script::ShaderSystem::Shader* mutable_shader();
  void set_allocated_shader(::Tiny3D::Script::ShaderSystem::Shader* shader);
  private:
  const ::Tiny3D::Script::ShaderSystem::Shader& _internal_shader() const;
  ::Tiny3D::Script::ShaderSystem::Shader* _internal_mutable_shader();
  public:

  // @@protoc_insertion_point(class_scope:Tiny3D.Script.FileFormat.FileShader)
 private:
  class _Internal;

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::Tiny3D::Script::FileFormat::FileHeader* header_;
  ::Tiny3D::Script::ShaderSystem::Shader* shader_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_FileScriptObject_2eproto;
};
// -------------------------------------------------------------------
...
// .Tiny3D.Script.FileFormat.FileHeader header = 1;
inline bool FileShader::_internal_has_header() const {
  return this != internal_default_instance() && header_ != nullptr;
}
inline bool FileShader::has_header() const {
  return _internal_has_header();
}
inline void FileShader::clear_header() {
  if (GetArenaNoVirtual() == nullptr && header_ != nullptr) {
    delete header_;
  }
  header_ = nullptr;
}
inline const ::Tiny3D::Script::FileFormat::FileHeader& FileShader::_internal_header() const {
  const ::Tiny3D::Script::FileFormat::FileHeader* p = header_;
  return p != nullptr ? *p : *reinterpret_cast<const ::Tiny3D::Script::FileFormat::FileHeader*>(
      &::Tiny3D::Script::FileFormat::_FileHeader_default_instance_);
}
inline const ::Tiny3D::Script::FileFormat::FileHeader& FileShader::header() const {
  // @@protoc_insertion_point(field_get:Tiny3D.Script.FileFormat.FileShader.header)
  return _internal_header();
}
inline ::Tiny3D::Script::FileFormat::FileHeader* FileShader::release_header() {
  // @@protoc_insertion_point(field_release:Tiny3D.Script.FileFormat.FileShader.header)
  
  ::Tiny3D::Script::FileFormat::FileHeader* temp = header_;
  header_ = nullptr;
  return temp;
}
inline ::Tiny3D::Script::FileFormat::FileHeader* FileShader::_internal_mutable_header() {
...
inline ::Tiny3D::Script::FileFormat::FileHeader* FileShader::mutable_header() {
  // @@protoc_insertion_point(field_mutable:Tiny3D.Script.FileFormat.FileShader.header)
  return _internal_mutable_header();
}
inline void FileShader::set_allocated_header(::Tiny3D::Script::FileFormat::FileHeader* header) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete header_;
  }
  ...
  header_ = header;
  // @@protoc_insertion_point(field_set_allocated:Tiny3D.Script.FileFormat.FileShader.header)
}

// .Tiny3D.Script.ShaderSystem.Shader shader = 2;
inline bool FileShader::_internal_has_shader() const {
  return this != internal_default_instance() && shader_ != nullptr;
}
inline bool FileShader::has_shader() const {
  return _internal_has_shader();
}
inline const ::Tiny3D::Script::ShaderSystem::Shader& FileShader::_internal_shader() const {
  const ::Tiny3D::Script::ShaderSystem::Shader* p = shader_;
  return p != nullptr ? *p : *reinterpret_cast<const ::Tiny3D::Script::ShaderSystem::Shader*>(
      &::Tiny3D::Script::ShaderSystem::_Shader_default_instance_);
}
inline const ::Tiny3D::Script::ShaderSystem::Shader& FileShader::shader() const {
  // @@protoc_insertion_point(field_get:Tiny3D.Script.FileFormat.FileShader.shader)
  return _internal_shader();
}
inline ::Tiny3D::Script::ShaderSystem::Shader* FileShader::release_shader() {
  // @@protoc_insertion_point(field_release:Tiny3D.Script.FileFormat.FileShader.shader)
  
  ::Tiny3D::Script::ShaderSystem::Shader* temp = shader_;
  shader_ = nullptr;
  return temp;
}
inline ::Tiny3D::Script::ShaderSystem::Shader* FileShader::_internal_mutable_shader() {
  
  if (shader_ == nullptr) {
    auto* p = CreateMaybeMessage<::Tiny3D::Script::ShaderSystem::Shader>(GetArenaNoVirtual());
    shader_ = p;
  }
  return shader_;
}
inline ::Tiny3D::Script::ShaderSystem::Shader* FileShader::mutable_shader() {
  // @@protoc_insertion_point(field_mutable:Tiny3D.Script.FileFormat.FileShader.shader)
  return _internal_mutable_shader();
}
inline void FileShader::set_allocated_shader(::Tiny3D::Script::ShaderSystem::Shader* shader) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  shader_ = shader;
  // @@protoc_insertion_point(field_set_allocated:Tiny3D.Script.FileFormat.FileShader.shader)
}
