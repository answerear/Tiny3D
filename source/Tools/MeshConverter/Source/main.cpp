...
// Text : -o Tiny3D -b sphere -t -a -r $(SolutionDir)..\..\assets\editor\builtin -d materials\Tiny3DStandard.tmat $(SolutionDir)..\..\assets\samples\raw\tortoise.fbx $(SolutionDir)..\..\assets\samples\meshes
