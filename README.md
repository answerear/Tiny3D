...
　　向量就是一个数字列表，对于我们程序员来说就是一个数组。数学上，一个向量就是一个数组。数学上区分向量和标量。标量是对我们平时所用数字的技术称谓。使用该术语时，是想强调数量值。例如：速度和位移就是向量，而速率和长度是标量。
...
1 \\ 2
\end{bmatrix}
\qquad  a_1=a_x=1 \qquad  a_2=a_y=2
\\
&\vec{b}=\begin{bmatrix}
3 \\ 4 \\ 5
\end{bmatrix}
\qquad b_1=b_x=3 \qquad b_2=b_y=4 \qquad b_3=b_z=5
\\
&\vec{c}=\begin{bmatrix}
5 \\ 6 \\ 7 \\ 8
\end{bmatrix}
\qquad c_1=c_x=6 \qquad c_2=c_y=7 \qquad c_3=c_z=8 \qquad c_4=c_w=9
\end{align}
$$
